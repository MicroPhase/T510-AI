...
BUILD_DIR="$TB_DIR/.xsim_tb_t510_ai_iq_wrapper_mode_exit_rearm"
TOP="tb_t510_ai_iq_wrapper_mode_exit_rearm"
...
VERILOG_FILES=(
  ...
  "$ROOT_DIR/lib/t510_ai_radio_ctrl/iq_framework/t510_ai_iq_capture.v"
  "$ROOT_DIR/lib/t510_ai_radio_ctrl/iq_framework/iq_framework_wrapper.v"
...
SV_FILES=(
  ...
  "$TB_DIR/tb_t510_ai_iq_wrapper_mode_exit_rearm.sv"
)
