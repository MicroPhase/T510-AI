...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01011902
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x08260F09
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B02200
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00020000
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00020000
    ...
    mask_write 0XFF0A000C 0x03FF03FF 0x03FD0002
    ...
    mask_write 0XFF0A000C 0x03FF03FF 0x03FD0000
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5 MS DELAY
