...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDRC_DRAMTMG1_OFFSET, 0x001F1F7FU, 0x0004041BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080110, 0xFFFFFFFFU ,0x08260F09U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR0_OFFSET, 0xFFFFFFFFU, 0x08260F09U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B02200U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00B02200U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_1_DIRECTION_1                                 0x20000

    * Direction mode (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0244, 0x03FFFFFFU ,0x00020000U)
    */
	PSU_Mask_Write(GPIO_DIRM_1_OFFSET, 0x03FFFFFFU, 0x00020000U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_1_OP_ENABLE_1                                  0x20000

    * Output enable (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0248, 0x03FFFFFFU ,0x00020000U)
    */
	PSU_Mask_Write(GPIO_OEN_1_OFFSET, 0x03FFFFFFU, 0x00020000U);
/*##################################################################### */
    ...
    *  PSU_GPIO_MASK_DATA_1_MSW_MASK_1_MSW                         0x3fd

    * Operation is the same as MASK_DATA_0_LSW[DATA_0_LSW]
    *  PSU_GPIO_MASK_DATA_1_MSW_DATA_1_MSW                         0x2

    * Maskable Output Data (GPIO Bank1, MIO, Upper 10 bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A000C, 0x03FF03FFU ,0x03FD0002U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_1_MSW_OFFSET,
		0x03FF03FFU, 0x03FD0002U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Maskable Output Data (GPIO Bank1, MIO, Upper 10 bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A000C, 0x03FF03FFU ,0x03FD0000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_1_MSW_OFFSET,
		0x03FF03FFU, 0x03FD0000U);
/*##################################################################### */
