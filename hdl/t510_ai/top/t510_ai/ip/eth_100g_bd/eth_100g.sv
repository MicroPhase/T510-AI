...
module eth_100g #(
  ...
  logic stat_rx_bip_err_0_0;
  logic stat_rx_bip_err_10_0;
  logic stat_rx_bip_err_11_0;
  logic stat_rx_bip_err_12_0;
  logic stat_rx_bip_err_13_0;
  logic stat_rx_bip_err_14_0;
  logic stat_rx_bip_err_15_0;
  logic stat_rx_bip_err_16_0;
  logic stat_rx_bip_err_17_0;
  logic stat_rx_bip_err_18_0;
  logic stat_rx_bip_err_19_0;
  logic stat_rx_bip_err_1_0;
  logic stat_rx_bip_err_2_0;
  logic stat_rx_bip_err_3_0;
  logic stat_rx_bip_err_4_0;
  logic stat_rx_bip_err_5_0;
  logic stat_rx_bip_err_6_0;
  logic stat_rx_bip_err_7_0;
  logic stat_rx_bip_err_8_0;
  logic stat_rx_bip_err_9_0;
  logic [19:0]stat_rx_block_lock;
  logic stat_rx_hi_ber;
  logic stat_rx_misaligned;
  logic [8:0]stat_rx_pause_req;
  logic [4:0]stat_rx_pcsl_number_0_0;
  logic [4:0]stat_rx_pcsl_number_10_0;
  logic [4:0]stat_rx_pcsl_number_11_0;
  logic [4:0]stat_rx_pcsl_number_12_0;
  logic [4:0]stat_rx_pcsl_number_13_0;
  logic [4:0]stat_rx_pcsl_number_14_0;
  logic [4:0]stat_rx_pcsl_number_15_0;
  logic [4:0]stat_rx_pcsl_number_16_0;
  logic [4:0]stat_rx_pcsl_number_17_0;
  logic [4:0]stat_rx_pcsl_number_18_0;
  logic [4:0]stat_rx_pcsl_number_19_0;
  logic [4:0]stat_rx_pcsl_number_1_0;
  logic [4:0]stat_rx_pcsl_number_2_0;
  logic [4:0]stat_rx_pcsl_number_3_0;
  logic [4:0]stat_rx_pcsl_number_4_0;
  logic [4:0]stat_rx_pcsl_number_5_0;
  logic [4:0]stat_rx_pcsl_number_6_0;
  logic [4:0]stat_rx_pcsl_number_7_0;
  logic [4:0]stat_rx_pcsl_number_8_0;
  logic [4:0]stat_rx_pcsl_number_9_0;
  ...
  assign rx_rec_clk_out = eth_100g_bd_wrapper.eth_100g_bd_i.cmac_usplus_0.gt_rxrecclkout[0];
  //status registers
  always_comb begin
    phy_status = 0;
  ...
  always_ff @(posedge mgt_clk,posedge areset) begin : rx_datapath_reset
    if (areset) begin
      gtwiz_reset_rx_datapath <= 1'b1;
    end else if (gtwiz_reset_rx_datapath & (reset_counter == 'd4) ) begin
  ...
  always_ff @(posedge mgt_clk ) begin
    if (areset==1'b1) begin
      ...
      reset_counter <= 'd0;
    end else if (gtwiz_reset_rx_datapath)  begin
  ...
  eth_100g_bd_wrapper eth_100g_bd_wrapper (
    .core_rx_reset(areset),
    .core_tx_reset(areset),
    .gtwiz_reset_rx_datapath(gtwiz_reset_rx_datapath),
    .gtwiz_reset_tx_datapath(areset),
