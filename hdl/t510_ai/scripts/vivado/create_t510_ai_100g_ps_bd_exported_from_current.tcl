...
################################################################
# This is a generated script based on design: t510_ai_100g_ps_bd
#
...
# source t510_ai_100g_ps_bd_script.tcl
...
set design_name t510_ai_100g_ps_bd
...
proc create_root_design { parentCell } {
  ...
  set axil_ctrl [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 axil_ctrl ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {39} \
   CONFIG.DATA_WIDTH {32} \
   CONFIG.HAS_BURST {0} \
  ...
  # Create ports
  set eth_rx_irq [ create_bd_port -dir I -from 0 -to 0 eth_rx_irq ]
  set eth_tx_irq [ create_bd_port -dir I -from 0 -to 0 eth_tx_irq ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {axil:axil_ctrl:axi} \
 ] $pl_clk40
...
\
  ...
  # Create instance: rst_ps_96M, and set properties
  set rst_ps_96M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps_96M ]
  ...
  connect_bd_intf_net -intf_net S02_AXI_0_1 [get_bd_intf_ports axi] [get_bd_intf_pins axi_smc/S02_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins ps/S_AXI_HPC1_FPD]
  connect_bd_intf_net -intf_net dac_clk_1 [get_bd_intf_ports dac_clk] [get_bd_intf_pins usp_rf_data_converter_0/dac0_clk]
  connect_bd_intf_net -intf_net ps_IIC_0 [get_bd_intf_ports i2c] [get_bd_intf_pins ps/IIC_0]
  connect_bd_intf_net -intf_net ps_M_AXI_HPM0_FPD [get_bd_intf_pins ps/M_AXI_HPM0_FPD] [get_bd_intf_pins ps_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps_axi_periph_M00_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins ps_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps_axi_periph_M01_AXI [get_bd_intf_ports axil] [get_bd_intf_pins ps_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps_axi_periph_M02_AXI [get_bd_intf_ports axil_ctrl] [get_bd_intf_pins ps_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps_axi_periph_M03_AXI [get_bd_intf_pins ps_axi_periph/M03_AXI] [get_bd_intf_pins usp_rf_data_converter_0/s_axi]
  ...
  connect_bd_net -net In2_0_1 [get_bd_ports eth_rx_irq] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net In3_0_1 [get_bd_ports eth_tx_irq] [get_bd_pins xlconcat_0/In3]
  ...
  connect_bd_net -net ps_pl_clk1 [get_bd_ports pl_clk40] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins ps/maxihpm0_fpd_aclk] [get_bd_pins ps/pl_clk1] [get_bd_pins ps/saxihpc1_fpd_aclk] [get_bd_pins ps_axi_periph/ACLK] [get_bd_pins ps_axi_periph/M00_ACLK] [get_bd_pins ps_axi_periph/M01_ACLK] [get_bd_pins ps_axi_periph/M02_ACLK] [get_bd_pins ps_axi_periph/M03_ACLK] [get_bd_pins ps_axi_periph/S00_ACLK] [get_bd_pins rst_ps_96M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk]
  connect_bd_net -net ps_pl_clk3 [get_bd_ports pl_clk200] [get_bd_pins ps/pl_clk3]
  connect_bd_net -net ps_pl_resetn0 [get_bd_ports pl_resetn0] [get_bd_pins ps/pl_resetn0] [get_bd_pins rst_ps_96M/ext_reset_in]
  ...
  connect_bd_net -net rst_ps_96M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps_axi_periph/ARESETN] [get_bd_pins ps_axi_periph/M00_ARESETN] [get_bd_pins ps_axi_periph/M01_ARESETN] [get_bd_pins ps_axi_periph/M02_ARESETN] [get_bd_pins ps_axi_periph/M03_ARESETN] [get_bd_pins ps_axi_periph/S00_ARESETN] [get_bd_pins rst_ps_96M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/m0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs ps/SAXIGP1/HPC1_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs ps/SAXIGP1/HPC1_DDR_LOW] -force
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces ps/Data] [get_bd_addr_segs axil/Reg] -force
  assign_bd_address -offset 0xA00C0000 -range 0x00040000 -target_address_space [get_bd_addr_spaces ps/Data] [get_bd_addr_segs axil_ctrl/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi] [get_bd_addr_segs ps/SAXIGP1/HPC1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi] [get_bd_addr_segs ps/SAXIGP1/HPC1_LPS_OCM] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs ps/SAXIGP1/HPC1_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs ps/SAXIGP1/HPC1_LPS_OCM]
